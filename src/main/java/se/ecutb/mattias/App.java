...
/**
 * Assignment School Management for Java at EcUtb.
 *
 * @Author: Mattias Franzén & Lukas Rasmussen.
 */
            ...
            switch (input) {
                case "1":
                    ...
                    if (choice.equalsIgnoreCase("S")) {
                        ...
                        System.out.println("You created: " + nyCourse + " Press enter to continue.");
                    }
                    System.out.println("Press a number again or press q to exit.");
                    break;
                case "2":
                    ...
                    if (choice2.equalsIgnoreCase("1")) {
                        ...
                        for (int i = 1; i < StudentList.getListLength(); i++) {
                            System.out.println(StudentList.findById(i));
                        }
                        Student temp = StudentList.findByEmail(sc.nextLine());
                        System.out.println("Choose a Course. Write the ID of the Course. ");
                        for (int i = 1; i < CourseList.getListLength() + 1; i++) {
                            System.out.println(CourseList.findById(i));
                        }
                ...
                case "3":
                    ...
                    if (choice3.equalsIgnoreCase("S")) {
                        ...
                        System.out.println(StudentList.findByName(Studentnamn) + " Press enter to continue.");
                        ...
                        System.out.println(CourseList.findByName(kursnamn) + " Press enter to continue.");
                    }
                    System.out.println("Press a number again or press q to exit.");
                    break;
                ...
                case "4":
                    ...
                    if (choice4.equalsIgnoreCase("S")) {
                        ...
                        System.out.println("Write a name.");
                        sc.nextLine();
                        temp.setCourseName(sc.nextLine());
                        System.out.println("Write the starting date.");
                        temp.setStartDate(LocalDate.parse(sc.nextLine()));
                        System.out.println("Write the length of the course.");
                        temp.setWeekDuration(Integer.parseInt(sc.nextLine()));
                        System.out.println(temp.toString() + " Press enter to continue.");
                        System.out.println("Press a number again or press q to exit.");
                    }
                    break;
            }
